package com.acme.application.views.gridwithfilters;

import com.acme.application.data.SamplePerson;
import com.acme.application.services.SamplePersonService;
...
@Menu(order = 12, icon = LineAwesomeIconUrl.FILTER_SOLID)
@Uses(Icon.class)
