...
public class UserMasterDetailView extends Div implements BeforeEnterObserver {
	...
	private DateTimePicker creation;
	private DateTimePicker lastAccess;
	...
	private void createEditorLayout(SplitLayout splitLayout) {
		...
		confirmPassword = new PasswordField("Confirma password");
		creation = new DateTimePicker("Criação");
		lastAccess = new DateTimePicker("Último acesso");
		active = new Checkbox("Ativo");
		confirmed = new Checkbox("Confirmou");

		formLayout.add(name, email, login, password, confirmPassword, creation, lastAccess, active, confirmed);
	...
	private void handleSave() {
		...
		try {
			...
			this.user.setPassword(USER_EDIT_ROUTE_TEMPLATE);
